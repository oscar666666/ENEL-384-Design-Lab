...
HD_PWD='C:/Users/lou207/Desktop/ENEL_384_Design_Lab/ENEL_384_Design_Lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Design_Lab_A.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Design_Lab_A.tcl -notrace
